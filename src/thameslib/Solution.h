...
public:
  ...
  */
  ...
  Solution(const string &dchFileName, const string &dbrFileName,
  ...
  */
  int getNumGEMPhases(void) { return numGEMPhases_; }
  ...
  */
  ...
  /**
  @brief Set the number of moles of all independent components (ICs) in the
  solution.
  ...
  */
  double *getICMoles(void) { return ICMoles_; }

  /**
  @brief Get the number of moles of an independent component (IC) specified by
  its index.
  ...
  */
  double getSI(int GEMPhaseId) { return SI_[GEMPhaseId]; }
  ...
  */
  double calculateCrystalStrain(double SI, double poreVolFrac, double Kp,
                                double Ks);
  ...
  */
  bool getJSONFormat(void) const { return jsonFormat_; }
