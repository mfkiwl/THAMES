  ...
  try {
    ...
    */
    ...
    if (DOH < 1.0) {
      ...
      cout << "New scaled mass = " << chemSys_->getMicroPhaseMass(microPhaseId_)
           << " and new volume = "
    ...
    //        #ifdef DEBUG
    //          if (!doTweak) {
    //              cout << "ParrotKillohModel::calculateKineticStep ICmoles
    //              after dissolving:" << endl;
    //          } else {
    //              cout << "ParrotKillohModel::calculateKineticStep ICmoles
    //              after tweaking:" << endl;
    //          }
    //          for (int i = 0; i < ICNum_; i++) {
    //            cout << "    " << ICName_[i] << ": " << ICMoles[i] << " mol"
    //            << endl;
    //          }
    //          cout.flush();
    //        #endif
