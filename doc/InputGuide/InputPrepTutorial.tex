...
\fbox{
\begin{minipage}{0.9\textwidth}
    \textbf{NOTE}: The \verb!<id>! values \textsc{must} be in order, starting
...
\fbox{
\begin{minipage}{0.9\textwidth}
    \textbf{NOTE}: Every solid phase \textsc{must} have an \verb!<affinity>! for
    itself, with an \verb!<affinityvalue>! greater than zero.
\end{minipage}
}
